...
<body>
	<div class="container">
		<h1>길이 변환</h1>
		<form type="post" action="/lesson02/quiz04_1.jsp">
			<div class="d-flex align-items-end">
				<input type="text" class="form-control col-2" name="length">
				<span>cm</span>
			</div>
			<div>
			<label>인치<input type="checkbox" name="type" value="inch"></label><!-- 서버가 알려면 value값이 있어야함 -->
			...
			<input type="submit" class="btn btn-success" value="변환하기"></input>
		</form>
	</div>
</body>
</html>