...
%>
	<div id="wrap" class="container ">
		<header class="bg-warning d-flex justify-content-start align-items-center">
		...
		<section class="contents">
			...
			<div class="d-flex mt-4 border border-success p-3">
				<%-- 이미지 --%>
				<div>
					<img src="<%= artistInfo.get("photo") %>" width="150" alt="앨범 표지">				
				</div>
				<%-- 가수정보 --%>
				<div class="ml-3">
			...
			<div class="mt-3">
				...
				<table class="table text-center">
					...
					%>
						<tr>
							<td><%= music.get("id") %></td>
							<td><a href="/lesson03/quiz02/layout2.jsp?title=1"><%= music.get("title") %></a></td>
